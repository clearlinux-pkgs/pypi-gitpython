...
Source0  : https://files.pythonhosted.org/packages/c0/89/37df0b71473153574a5cdef8f242de422a0f5d26d7a9e231e6f169b4ad14/gitpython-3.1.44.tar.gz
...
%prep
%setup -q -n gitpython-3.1.44
cd %{_builddir}/gitpython-3.1.44
pushd ..
cp -a gitpython-3.1.44 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735830285
