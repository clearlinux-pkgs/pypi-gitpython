...
Source0  : https://files.pythonhosted.org/packages/e5/c2/6e3a26945a7ff7cf2854b8825026cf3f22ac8e18285bc11b6b1ceeb8dc3f/GitPython-3.1.41.tar.gz
...
%prep
%setup -q -n GitPython-3.1.41
cd %{_builddir}/GitPython-3.1.41
pushd ..
cp -a GitPython-3.1.41 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704901815
