...
Source0  : https://files.pythonhosted.org/packages/1e/2d/6ccc5a2a05a474e7ae7ef7b1372ead9381378c438da4cc3434109b376d82/GitPython-3.1.28.tar.gz
...
%prep
%setup -q -n GitPython-3.1.28
cd %{_builddir}/GitPython-3.1.28
pushd ..
cp -a GitPython-3.1.28 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665152960
